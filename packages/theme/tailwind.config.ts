  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        primary: {
          900: "hsla(var(--primary-hue), var(--primary-saturation), 20%)",
          800: "hsla(var(--primary-hue), var(--primary-saturation), 30%)",
          700: "hsla(var(--primary-hue), var(--primary-saturation), 40%)",
          600: "hsla(var(--primary-hue), var(--primary-saturation), 50%)",
          500: "hsla(var(--primary-hue), var(--primary-saturation), 60%)",
          DEFAULT: "hsla(var(--primary-hue), var(--primary-saturation), 60%)",
          400: "hsla(var(--primary-hue), var(--primary-saturation), 70%)",
          300: "hsla(var(--primary-hue), var(--primary-saturation), 80%)",
          200: "hsla(var(--primary-hue), var(--primary-saturation), 90%)",
          100: "hsla(var(--primary-hue), var(--primary-saturation), 95%)",
        },
