...
<pre>
  <div className="px-4 py-2 flex gap-4 justify-center items-center">
    <Button size="lg" variant="vanilla" floating>
      <span>Vanilla</span>
    </Button>
    <Button size="md" variant="orange" floating>
      <span>Orange</span>
    </Button>
    <Button size="sm" variant="avocado" floating>
      <span>Avocado</span>
    </Button>
  </div>
</pre>
...
```js
<Button size="lg" variant="vanilla" floating>Vanilla</Button>
<Button size="md" variant="orange" floating>Orange</Button>
<Button size="sm" variant="avocado" floating>Avocado</Button>
```
