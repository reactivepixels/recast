      ...
      <div className="flex flex-col gap-16 w-full">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:items-center">
            ...
            <Button size="md" variant="primary" pill>Secondary</Button>
            <Button size="lg" variant="primary" pill>Tertiary</Button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:items-center">
            <h4 className="font-bold w-24 lg:text-end text-sm">Pill:</h4>
            <Button size="sm" variant="secondary" pill>Primary</Button>
            <Button size="md" variant="secondary" pill>Secondary</Button>
            <Button size="lg" variant="secondary" pill>Tertiary</Button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:items-center">
            <h4 className="font-bold w-24 lg:text-end text-sm">Pill:</h4>
            <Button size="sm" variant="outline" pill>Primary</Button>
            <Button size="md" variant="outline" pill>Secondary</Button>
            <Button size="lg" variant="outline" pill>Tertiary</Button>
          </div>
        </div>
      </div>
    </ComponentPreview>
