...
<Frame>
  <BlueprintCard>
    <section className="flex flex-col gap-8">
      ...
      <FadeCarousel className="h-32">
        <div className="absolute w-full h-full flex items-center justify-center">
          <button className="button-base button-outline button-small w-full">Recast</button>
        </div>
        <div className="absolute w-full h-full flex items-center justify-center">
          <button className="button-base button-solid button-medium w-full">Recast</button>
        </div>
        <div className="absolute w-full h-full flex items-center justify-center">
          <button className="button-base button-outline button-large">Recast</button>
        </div>
      </FadeCarousel>
    </section>
  </BlueprintCard>
