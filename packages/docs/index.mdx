  ...
  <BlueprintCard>
    <section className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2 items-center">
        <h4 className="text-xs uppercase font-mono">outline:md</h4>
        <button className="button-base button-outline button-medium w-full">Outline</button>
      </div>

      <div className="flex flex-col gap-2 items-center">
        <h4 className="text-xs uppercase font-mono">default:sm</h4>
        <button className="button-base button-solid button-smal w-full">Default</button>
      </div>
    </section>
  </BlueprintCard>
</Frame>
